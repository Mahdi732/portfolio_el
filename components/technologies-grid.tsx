...
const technologies = [
  { name: "JavaScript", category: "Language", proficiency: 95, interest: 90 },
  { name: "TypeScript", category: "Language", proficiency: 85, interest: 88 },
  { name: "PHP", category: "Language", proficiency: 80, interest: 70 },
  { name: "React", category: "Frontend", proficiency: 92, interest: 95 },
  { name: "React Native", category: "Frontend", proficiency: 80, interest: 85 },
  { name: "Vue.js", category: "Frontend", proficiency: 85, interest: 80 },
  ...
  { name: "Bootstrap", category: "Styling", proficiency: 85, interest: 75 },
  { name: "Chakra UI", category: "Styling", proficiency: 80, interest: 82 },
  { name: "Framer Motion", category: "Animation", proficiency: 88, interest: 95 },
  { name: "GSAP", category: "Animation", proficiency: 82, interest: 85 },
  { name: "anime.js", category: "Animation", proficiency: 75, interest: 78 },
  { name: "Node.js", category: "Backend", proficiency: 88, interest: 90 },
  { name: "Express.js", category: "Backend", proficiency: 85, interest: 85 },
  { name: "Laravel", category: "Backend", proficiency: 80, interest: 78 },
